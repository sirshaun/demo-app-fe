    ...
    <div class="mb-20">
      <div class="clearfix mt-6">
        <div class="float-left">
          <a class="cursor-pointer text-indigo-600 hover:text-indigo-200">
            All lists
          </a>
        </div>
        <a
        ...
        >
          <svg
            class="h-5 text-indigo-500 hover:text-indigo-400 fill-current"
      ...
      <div class="mt-8">
        ...
        <div class="font-light text-normal">
          <span>{{ dates }}</span>
          &bull;
          <span>{{ pluralize("guest", wishlist.numberOfGuests, true) }}</span>
        </div>
        <div class="mt-8">
          <a
        ...
        <div>
          ...
          <div class="mt-4">
            <div class="" v-for="(stay, index) in stays" :key="100 - index">
              ...
              <div class="mt-1 px-1">
                ...
                <div class="flex items-center">
                  <svg
                    ...
                    viewBox="0 0 24 24"
                    :class="
                      i <= stay.rating ? 'text-indigo-500' : 'text-gray-400'
                    "

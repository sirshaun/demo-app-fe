		...
		<div class="relative px-4 -mt-16 max-w-md">
			<div class="bg-white p-6 rounded-lg shadow-lg">
				<div class="flex items-baseline">
					<span
						class="inline-block bg-indigo-200 text-indigo-800 text-xs px-2 rounded-full uppercase font-semibold tracking-wide"
						>New</span
					>
					<div
				...
				<h4 class="font-semibold text-lg leading-tight truncate mt-1">
					{{ property.title }}
				</h4>
				<div class="mt-1">

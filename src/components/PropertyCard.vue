		...
		<div class="relative px-4 -mt-16">
			<div class="bg-white p-6 rounded-lg shadow-lg">
				<div class="flex items-baseline">
					<span class="inline-block bg-indigo-200 text-indigo-800 text-xs px-2 rounded-full uppercase font-semibold tracking-wide">New</span>
				...
				<div class="mt-2 flex items-center">
					<svg v-for="i in 5" :key="i" viewBox="0 0 24 24" :class="i <= property.rating ? 'text-indigo-500' : 'text-gray-400'" class="h-4 w-4 fill-current">

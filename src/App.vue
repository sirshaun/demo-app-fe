		...
		<div class="bg-gray-100 flex">
			<div class="px-8 py-12 mx-w-md mx-auto sm:mx-w-xl lg:max-w-full lg:w-1/2 lg:py-24 lg:px-12">
        		<div class="xl:max-w-lg xl:ml-auto">
		        	...
		        	<p class="mt-2 sm:mt-4 text-gray-600 sm:text-xl">Workcation helps you find work-friendly rentals in beautiful locations so you can enjoy some nice weather even when you're not on vacation.</p>
		        	<div class="mt-4 sm:mt-6">
		        		<a class="btn bg-brand-blue text-white shadow-lg sm:text-base" href="#">Book your escape</a>

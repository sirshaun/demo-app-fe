  ...
  <div class="oped" v-if="user.spokenLanguages">
    ...
    <div class="md:px-64 pt-20 bg-gray-200">
      <div class="flex text-gray-800">
        <div class="w-1/3">
          <div class="w-9/12 flex flex-col bg-white border rounded shadow">
            ...
            <div class="px-4 py-2 m-2" v-show="user.verified">
              <div class="font-semibold mb-4">{{ user.username }} provided</div>
              <div class="flex items-center mb-2" v-show="user.identification">
                <svg
                  class="h-4 mr-2 text-gray-700 fill-current"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 20 20"
              ...
              <div class="flex items-center mb-2" v-show="user.email_verified">
                <svg
                  class="h-4 mr-2 text-gray-700 fill-current"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 20 20"
              ...
              <div class="flex items-center" v-show="user.mobile_verified">
                <svg
                  class="h-4 mr-2 text-gray-700 fill-current"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 20 20"
        ...
        <div class="w-2/3 mb-20">
          <div class="flex flex-col bg-white border rounded shadow">
            <div class="px-4 py-2 mx-2 my-6">
              <div class="text-5xl font-light">Hi, I'm {{ user.username }}</div>
            ...
            <div class="px-4 py-2 mx-2 my-6" id="profile-reviews">
              ...
              <div class="" v-for="(review, index) in reviews" :key="index">
                ...
                <div class="flex items-center">
                  ...
                  />
                  <div class="text-sm">
                    <p class="font-semibold text-sm leading-none mb-1">
                      {{ review.reviewer_title }}
                    </p>
                    <p class="text-gray-600 font-thin text-xs">
                      Joined in
                      {{ review.reviewer_joined }}
                    </p>
                  </div>
                </div>
                <hr class="my-6" v-show="index != reviews.length - 1" />
              </div>
            </div>
            <hr class="mx-5" />
            <div class="px-4 py-2 mx-2 my-6">
